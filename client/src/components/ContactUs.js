...
const ContactUs = () => {
    ...
    return (
        <>
            <div className="flex sm:w-11/12 lg:w-3/12  max-w-sm mx-auto overflow-hidden  rounded-lg shadow-lg backdrop-blur-md border-t-2 border-b-2  lg:max-w-4xl ">
                ...
                <div className="w-full px-6 py-8 md:px-8 ">
                    ...
                    <div className="mt-4">
                        <div className="flex justify-between">
                            <label className="block mb-2 text-sm font-medium text-gray-200 dark:text-gray-200" htmlFor="loggingPassword">Message</label>
                        </div>

                        <input id="loggingPassword" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" type="text"
